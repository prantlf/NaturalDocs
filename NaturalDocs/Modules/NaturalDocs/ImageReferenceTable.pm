...
#       ImageReferenceTable.nd stores each reference's target, width, and height, and whether they changed it dealt with in
#       the <Load()> function, again since the list of targets (image files) is constant.
#
