...
sub UpdateMenu
    ...
    print OUTPUTFILEHANDLE
        ...
        . '</head><body class=FramedMenuPage>'
            ...
            . $self->BuildMenu(NaturalDocs::File->JoinPaths(NaturalDocs::Settings->OutputDirectoryOf($self), 'menu.html'), 1)
            ...
            . '<html>'
                ...
                . '<frameset cols="185,*">'
                    ...
                    . '<frame name=Content src="'
                        . $self->MakeRelativeURL($indexFile, $self->OutputFileOf($firstMenuEntry->Target())) . '">'
                . '</frameset>'
